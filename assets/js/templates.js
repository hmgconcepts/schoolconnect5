...
<script>
  ...
  roleAllow(id) {
    ...
    const map = {
      // Safe common pages
      dashboard: allUsers, notifications: allUsers, inbox: allUsers, 'feature-guide': allUsers, about: publicPages, contact: publicPages, apply: publicPages,
      ...
      'timetable-generator': staff, sow: staff, lesson_plans: staff, messages: staff, broadcast: staff, reports: staff, directory: staff, leave: staff, visitors: staff,
